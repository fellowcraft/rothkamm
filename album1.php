...
$newname = 'http://'.$_SERVER["HTTP_HOST"].'/MP3320/'
...
<?php $cover_image = 
"http://".$_SERVER["HTTP_HOST"]."/pictures/albumcover/".$album_R["Artist"]."-".$album_R["Name"].".jpg";
...
<link rel="image_src"        href="<?php echo $cover_image; ?>">
<meta property="og:image" content="<?php echo $cover_image; ?>">
<meta property="og:url"   content="<?php echo "http://".$_SERVER["HTTP_HOST"]."/album.php?".$URLAlbum; ?>">
...
$TimeLength =  round($TT_R["seconds"]/60,0).":". 
sprintf("%02d",round($TT_R["seconds"]%60,0));
