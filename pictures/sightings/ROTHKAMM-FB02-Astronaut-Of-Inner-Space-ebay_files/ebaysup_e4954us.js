...
{var c=new EbayAdTableConfig(pName);c.ncount=pNumberofAds;c.orientation=pOrientation?pOrientation:"";c.rows=pRows?pRows:0;c.cellspacing=pCellSpacing?pCellSpacing:0;c.ifWidth=pIFW?pIFW:0;c.ifHeight=pIFH?pIFH:0;setAdsTableSize(c,pSizes);setAdsTableIFSize(c,pSizes);c.DARTSite=new String(pDARTSite);c.zones=pZone;c.tile=pTile?pTile:0;c.bNoTn=pNoTn?pNoTn:0;pAddDcopt=pAddDcopt||false;if(pAddDcopt)
