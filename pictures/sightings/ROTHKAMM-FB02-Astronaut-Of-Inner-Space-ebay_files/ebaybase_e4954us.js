...
if(!isSecure)
pro="http:";pro+="//";sPicsDir=pro+sPicsDir;sIncludeDir=sIncludeHost+"aw/pics/lib/";sCountryIncludeDir=sIncludeDir+sCountry+"/";sIncludeDir+="_global/";sJSPackageSuffix=(sTrainId.is("v")?"":("_e4954"+sCountry))+".js";if(sThisPageHost.has(sb+".")&&!sCountry.hasAny("befr","benl","tw","us"))
...
{var a=arguments;return this.hasAllInArray(a);}
...
{var hPath="/help/",hIndexPath=hPath+"index.html",hInd;var dl=this.oDocument.doc.links,url,pre,post,oTxt;for(var i=dl.length-1;i>-1;i--)
...
{if(!this.objType)
this.objType="EbayNSDetect";this.base=EbayBaseControl;this.base(pParent,pName);this.aRotationIDs=new Array();this.isTop=function()
{var oD=this.oDocument,w=oD.win,d=oD.doc;var p=(w.parent==w);var o=(typeof(w.opener)!='undefined');var r=d.referrer;if(p&&(!o||(o&&(r!=""))))
return true;else
return false;}
this.init=function()
{if(this.isTop())
{this.track();}}
this.track=function()
{var oCJ=ebay.oDocument.oCookieJar;var cl=oCJ.readCookielet("ebay","pim");var cl2=oCJ.readCookielet("npii","tpim");if(cl2)
{oCJ.writeCookielet("ebay","pim","");oCJ.writeCookielet("npii","tpim","");}
else if(cl)
{if(cl==3)
{this.writeImg();}
oCJ.writeCookielet("ebay","pim","");}
else
{this.writeImg();}}
this.addRotationId=function(pKey,pValue)
